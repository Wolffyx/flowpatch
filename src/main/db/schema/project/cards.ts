/**
 * Cards Table Schema (Project DB)
 *
 * Stores cards for a single project. The project_id is implicit
 * since this table lives in the project's local .flowpatch/project.db.
 */
